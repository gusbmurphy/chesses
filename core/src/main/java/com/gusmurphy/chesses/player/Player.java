...
public class Player {
    ...
    public Optional<PieceColorAndMovement> selectPieceToMove(BoardState board, BoardCoordinates spot) {
        Optional<PieceColorAndMovement> pieceAtSpot = board.getPieceAt(spot);
